...
void GiantStrength::useTriggered(int owner, int playedminion, int minionowner, bool isOwnerActive, When when) { minion->useTriggered(owner,playedminion,minionowner,isOwnerActive,when); }
